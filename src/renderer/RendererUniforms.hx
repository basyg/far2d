...
abstract RendererUniforms(Vector<Float>) to Vector<Float> {
	...
	public inline function new(registersCount:Int) {
		this = new Vector(registersCount << 2, true);
	}
	
	public inline function clear():Void {
		for (i in 0...getRegistersCount()) {
			var j = i << 2;
			this[j + 0] = 0.0;
			this[j + 1] = 0.0;
			this[j + 2] = 0.0;
	...
	public inline function getRegistersCount():Int {
